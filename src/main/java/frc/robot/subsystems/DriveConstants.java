...
public class DriveConstants {
        ...
        public static final double MaxSpeed = 1; // 6 Meters per second or 19.6850394 freedom units per second
        public static final double MaxAngularRate = 0.5 * Math.PI; // 3/4 of a rotation in radians (for some reason)
