...
public class VisionSubsystem extends SubsystemBase {
    ...
    TimeOfFlight ampTOF = new TimeOfFlight(23);
    ...
    public void setAlignSpeeds() {
        ...
        yAmpSpeed = -MathUtil.clamp((AlignPIDY.calculate(ampTOF.getRange(), AmpAlignSetpointY)), -MaxSpeed / 4, MaxSpeed / 4);
    }
