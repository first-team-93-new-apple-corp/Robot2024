...
public class ArmCommand extends CommandBase {
 ...
 enum ArmState {
  ...
  HashMap<ArmCommand.ArmState, double[]> Positions = new HashMap<ArmCommand.ArmState, double[]>(); //TODO change hashmap to include positions/speeds of all subsystems for different setpoints
  public ArmCommand(ArmState state,
      TelescopingSubsystem m_TelescopingSubsystem, ShoulderSubsystem m_ShoulderSubsystem, GrabberSubsystem m_GrabberSubsystem, WristSubsystem m_WristSubsystem, ArmState Position) {
  ...
  public void execute() {
    ...
    //telescoping subsystem should only move once the arm is outside of the robotframe/ won't clip with the robot.
