...
public class DriveConstants {
        ...
        public static final double MaxSpeed = 6*.75; // 2 Meters per second or 6.56167979 freedom units per second          (Connor's MaxSpeed)
        public static final double MaxAngularRate = 1.5 * Math.PI; // 1/4 of a rotation in radians                       (Connor's MaxAngularRate)
